...
theta = zeros(3, 1);
[theta, J_history] = gradientDescentMulti(X, y, theta, alpha_1, num_iters);
...
% Plot Gradient Descent with different alpha values
hold on;
theta = zeros(3, 1)
...
orig_data = [1650 3];
norm_data = [1 (orig_data .- mu) ./ sigma];
price = norm_data * theta; % You should change this
